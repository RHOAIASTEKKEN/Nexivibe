...
import TekkenPost from './TekkenPost';
import StoryCardData from './StoryCardData';
import { motion } from 'framer-motion';

const StoryComponent = ({ className, user }) => {
    ...
    return (
        <div className={`story-container ${className || ''}`}>
            <TekkenPost user={user} openModal={openModal} />
            <StoryCardData user={user} openModal={openModal} />
